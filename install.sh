#!/bin/bash
# Installs Open Whisper System's IntelliJ configs into your user configs.

echo "Installing Open Whisper Systems code style configs..."
...
echo "Done."
echo ""
echo "Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Open Whisper Systems'."
